...
value ('제목1', '내용1', 0, now(), 1);

insert into p1_board(titl, cont, cnt, cdt, mno)
value ('제목2', '내용2', 0, now(), 1);

insert into p1_board(titl, cont, cnt, cdt, mno)
value ('제목3', '내용3', 0, now(), 1);

insert into p1_board(titl, cont, cnt, cdt, mno)
value ('제목4', '내용4', 0, now(), 2);

insert into p1_board(titl, cont, cnt, cdt, mno)
value ('제목5', '내용5', 0, now(), 2);

insert into p1_board(titl, cont, cnt, cdt, mno)
value ('제목6', '내용6', 0, now(), 4);

insert into p1_board(titl, cont, cnt, cdt, mno)
value ('제목7', '내용7', 0, now(), 4);

insert into p1_board(titl, cont, cnt, cdt, mno)
value ('제목8', '내용8', 0, now(), 4);
...
insert into p1_att_file(fi_nm,bno) value('file7.txt',9);
