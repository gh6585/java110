...
public class ApplicationContext {
    ...
    public ApplicationContext(String packageName) throws Exception {
        ...
        //패키지 폴더에 들어 있는 클래스를 찾아 클래스를 로디한 후 목록에 저장한다.
        findClass(file,path);
        ...
        //objPool에 보관된 객체를 꺼내 @Autowired 가붙은 셋터를 찾아 호출한다.
        //=>의존 객체 주입
        injectDependency();
    ...
    private void createInstacne() {
        for (Class<?> clazz : classes) {
            ...
            // => @Compenent 애노테이션이 붙지 않은 클래스는 객체를 생성하지않는다
