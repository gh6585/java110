...
public class TeacherDetailServlet extends HttpServlet {
    ...
    protected void doGet(
        ...
        if (t == null) {
            ...
            out.println("<table>");
            out.println("<tbody>");
            out.printf("<tr><th>번호</th><td>%d</td></tr>" , t.getNo());
            out.printf("<tr><th>이름</th><td>%s</td></tr>" , t.getName());
            out.printf("<tr><th>이메일</th><td>%s</td></tr>" , t.getEmail());
            out.printf("<tr><th>암호</th><td>%s</td></tr>" , t.getPassword());
            out.printf("<tr><th>전화</th><td>%s</td></tr>" , t.getTel());
            out.printf("<tr><th>돈</th><td>%s</td></tr>" , t.getPay());
            out.printf("<tr><th>과목</th><td>%s</td></tr>" , t.getSubjects());
            out.println("</tbody>");
            out.println("</table>");
