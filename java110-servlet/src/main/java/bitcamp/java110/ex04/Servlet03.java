...
public class Servlet03 extends GenericServlet {
    ...
    public void service(
        ...
        // 멀티파트 형식으로 업로드 된 데이터를 getParamerter()로 값을 꺼낼 수 없다.
        // => 별도의 처리 작없을 해야한다.
        ...
        //    => 각 파트는 DiskFileUtemFactory를 통해 FileItem 객체로 만든다.
        //
            ...
            for (FileItem item : items) {
                if(item.isFormField()) {// 일반 데이터
                   ...
                   String path = this.getServletContext().
                    ...
                    item.write(new File(path));//지정된 path 에저장됨.(upload파일)
