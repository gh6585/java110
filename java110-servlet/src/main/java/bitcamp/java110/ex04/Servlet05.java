...
public class Servlet05 extends GenericServlet {
    ...
    public void service(
        ...
        // 테스트:
        // => http://localhost:8888/ex04/post2.html 페이지에서 값을 입력한 후 
        //
        
        // => 클라이언트가 보낸 데이터가  어떤 문자표로 인코딩 문자표를 알려준다.
        //    만약 알려주지 않으면, IOS-8859-1로 인코딩되었다고 간주한다.
        //    즉 클라이언트가 보낸 데이터가 모두 영무이나 숫자라고 간주하고,
