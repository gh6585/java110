 ...
 * => 쿠키의 사용 기간을 지정하면,
 *    웹브라우저는 별도의 파일에 보관한다.
 *    그래서 웹브라우저는 쿠키의 유호기간 동아넹는 서버에서 쿠키를 제시한다.
 *    유효기간이 지마면 로컬에 지정된 쿠키를 삭제한다.ㄴ
 */
...
Set-Cookie: age=12; Max-Age=60; Expires=Mon, 01-Oct-2018 03:35:05 GMT; Path=/   <=== 종료날짜 지정됨
Set-Cookie: working=true; Max-Age=86400; Expires=Tue, 02-Oct-2018 03:34:05 GMT; Path=/
Content-Type: text/html;charset=UTF-8
Content-Length: 140
Date: Mon, 01 Oct 2018 03:34:05 GMT
         */
