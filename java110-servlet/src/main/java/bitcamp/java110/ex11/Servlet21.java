...
public class Servlet21 extends HttpServlet {
    ...
    protected void doGet(
        ...
        //      => 응답할 때 응답 프로토콜의 쿠키 정보로 새로
        //         생성한 세션객체의 세션 아이디를 보낸다.
        //      => 웹브라우저는 서버로부터 받은 쿠키데이터인 세션ID를
        //         서버에 요청할 때 마다 보낼 것이다.
        // 세션ID를 응답 프로토콜로 보내는 예)
        // => 톰캣 서버에서는 JESSIONID라는 쿠키 이름으로 세션 아이디를 보낸다.
        // => WAS 마다 세션ID의 쿠키이름이 다를수 있다.
        /*
HTTP/1.1 200
Set-Cookie: JSESSIONID=0C105FDC5F6FD2B23C96B98130762231; Path=/; HttpOnly
Content-Type: text/html;charset=UTF-8
Content-Length: 147
Date: Tue, 02 Oct 2018 00:37:54 GMT
        */
