...
public class Servlet22 extends HttpServlet {
    ...
    protected void doGet(
        ...
        // 세션 얻기
        // => /ex11/ervlet21을 먼저 실행한 후 이 서블릿을 실행하면,
        //    웹브라우저가 서버에 요청할 때 이전 서블릿에서 받은 세션 아이디를
        //    요청 프로토콜의 쿠키에 담아서 제출할 것이다.
        //
        // 요청 프로토콜의 세션아이디 쿠키 정보 예)
        /*
GET /ex11/servlet22 HTTP/1.1
...
Cookie: working=true; JSESSIONID=0C105FDC5F6FD2B23C96B98130762231    <==== 세션 아이디 제출
        */
        // 응답 프로토콜의 예)
        // => 웹브라우저가 세션 아이디를 갖고 있기때문에 다시 세션아이디를 보내지 않는다.
        /*
HTTP/1.1 200
Content-Type: text/html;charset=UTF-8
Content-Length: 172
Date: Tue, 02 Oct 2018 01:04:04 GMT
         * */
