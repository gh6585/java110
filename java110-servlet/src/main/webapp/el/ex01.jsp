...
<h1>EL 표기법</h1>
<pre>
- EL(Expression Language)은 콤마(.)와 대괄호([]) 등을 상요하여 객체의 프로퍼티나,
     리스트, 셋, 맵 객체의 값을 쉽게 써내고 설정하게 도와주는 문법이다.
