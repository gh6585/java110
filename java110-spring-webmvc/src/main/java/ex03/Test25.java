...
public class Test25 {
    ...
    // 테스트:
    //      http://localhost:8888/app/ex03/test25/search/sonata/red/auto/2013
    //
    ...
    // @MatrixVariable 애노테이션을 사용하려면 스프링 설정에서 활성화시켜야
    // 1) XML 설정
